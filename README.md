...
A portfolio-safe online retail dataset: 150 customers, 50 products, 500 orders, 1,539 order line items, and 30 returns, covering Jan-Dec 2023. Full schema in [`docs/data_dictionary.md`](docs/data_dictionary.md).
